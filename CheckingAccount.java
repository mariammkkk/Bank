...
public class CheckingAccount {
    ...
    public static void main(String[] args) {
        System.out.println("Welcome! Let's open a checking account!");
        Scanner scanner = new Scanner(System.in);
    
        System.out.println("Please enter the initial balance you will be depositing into your account: ");
        double initialBalance = scanner.nextDouble();

        CheckingAccount checkingAccount = new CheckingAccount(initialBalance);

        System.out.println("Congratulations! You have now successfully opened a checking account!");
